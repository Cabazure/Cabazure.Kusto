...
|-----------|----------|----------|
| Public API design, architecture, reviewer gates | Ripley | New execution surfaces, behavioral trade-offs, cross-cutting library changes |
| Core C# library implementation | Parker | `KustoProcessor`, `KustoClientProvider`, DI wiring, handler plumbing |
| ADX/Kusto semantics and script behavior | Ash | CSL parameters, embedded scripts, stored query results, continuation tokens |
| Testing and quality review | Lambert | Unit tests, deserialization edge cases, pagination regressions, reviewer rejections |
| Release, packaging, docs, sample app | Dallas | GitHub Actions, NuGet packaging, `README.md`, `samples\\SampleApi` |
